<div class="max-w-screen-2xl mx-auto h-16 bg-[#DFDFDF]  shadow-xl shadow-gray-400/40">
   ...
   <div class="inline-block my-5 mx-10">
    ...
    @endif
    <input class='float-right text-[#929292] border-none bg-[#D9D9D9] rounded-xl inline-block w-60 mx-10 my-3' placeholder="Search ...">  
    <label class="absolute right-24 float-right my-5">@include('components.icons.search')</label> 
