    ...
    <div class="max-w-screen-2xl mx-auto min-h-screen ">
        ...
        <div class="my-12 ">
            ...
            @if ($item->category_id == 1)
                <div class="text-7xl my-2 pb-5 text-gray-800 border-b border-dashed border-gray-300 font-medium relative text-center">Фильм {{ $item->name }}
                    ({{ $year->title }}) </div>
            ...
            <div class="block my-10">
                <div class="w-[1000px] mx-auto ">
                    ...
                    <div class="inline-block relative bottom-12 pl-2  border-l border-dashed border-gray-300 text-gray-700 ml-24 mr-12">
                        ...
                        <div class="block absolute  w-[600px] h-48 overflow-hidden top-52   text-justify  text-xl font-medium text-gray-700">
